...
class ChatSDKService extends ChatUIKitServiceBase
  ...
  Future<bool> changeAppId(String appId) async {
    return await Client.getInstance.changeAppId(newAppId: appId);
  }

  Future<bool> changeAppKey(String appKey) async {
    return await Client.getInstance.changeAppKey(newAppKey: appKey);
  }
